      ...
      <div>
        <div className="container flex flex-col items-center px-5 py-6 mx-auto sm:flex-row">
          ...
          <span className="inline-flex justify-center mt-4 sm:ml-auto sm:mt-0 sm:justify-start">
            <a className="text-gray-500 cursor-pointer" href="mailto:tjdsksro90@gmail.com" target="_blank">
              <svg
                fill="currentColor"
                strokeLinecap="round"
            ...
            <a className="ml-3 text-gray-500 cursor-pointer" href="https://github.com/tjdsksro90" target="_blank">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <a className="ml-3 text-gray-500 cursor-pointer" href="https://www.instagram.com/hojun456" target="_blank">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
